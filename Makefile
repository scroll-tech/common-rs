...
again:
	MODE=sushi cargo test --features prove_verify --release test_evm_prove_verify > 0708.sushi.evm.txt 2>&1; MODE=sushi cargo test --features prove_verify --release test_state_prove_verify > 0708.sushi.state.txt 2>&1
